...
<html lang="en" dir="ltr">
  ...
  <title>MERAMPUT-BLOG ADMIN</title>
          ...
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
              <a href="adminindex">
                ...
                <span class="brand-name">MERAMPUT-BLOG</span>
              </a>
            </div>
                        ...
                        <li  class="has-sub" >
                          ...
                          <ul  class="collapse"  id="components">
                            <div class="sub-menu">
                              ...
                              <li >
                                <a href="{{url('admin/artikel')}}">Lokal Brand</a>
                              </li>
            ...
            <nav class="navbar navbar-static-top navbar-expand-lg">
              ...
              <div class="search-form d-none d-lg-inline-block">
                <div class="input-group">
                  ...
                  <input type="text" name="query" id="search-input" class="form-control" placeholder="'promo', etc."
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      <img src="{{url('public')}}/admin/assets/img/user/imam.jpg" class="user-image" alt="User Image" />
                      <span class="d-none d-lg-inline-block">@if(Auth::check()) {{request()->user()->nama}} @else Silahkan Login @endif</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
                      <li class="dropdown-header">
                        <img src="{{url('public')}}/admin/assets/img/user/imam.jpg" class="img-circle" alt="User Image" />
